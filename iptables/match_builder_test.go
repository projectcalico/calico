...
var _ = DescribeTable("MatchBuilder",
	...
	// CIDRs.
	Entry("SourceNets", Match().SourceNet("10.0.0.4"), "--source 10.0.0.4"),
	Entry("NotSourceNets", Match().NotSourceNet("10.0.0.4"), "! --source 10.0.0.4"),
	Entry("DestNets", Match().DestNet("10.0.0.4"), "--destination 10.0.0.4"),
	Entry("NotDestNets", Match().NotDestNet("10.0.0.4"), "! --destination 10.0.0.4"),
	// IP sets.
