...
var _ = DescribeTable("MatchBuilder",
	...
	// CIDRs.
	Entry("SourceNets", Match().SourceNets("10.0.0.4"), "--source 10.0.0.4"),
	Entry("NotSourceNets", Match().NotSourceNets("10.0.0.4"), "! --source 10.0.0.4"),
	Entry("DestNets", Match().DestNets("10.0.0.4"), "--destination 10.0.0.4"),
	Entry("NotDestNets", Match().NotDestNets("10.0.0.4"), "! --destination 10.0.0.4"),
	// IP sets.
