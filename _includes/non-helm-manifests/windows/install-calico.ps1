...
Param(
    [parameter(Mandatory = $false)] $ReleaseBaseURL="https://storage.googleapis.com/tigera-windows/",
    [parameter(Mandatory = $false)] $ReleaseFile="calico-os-{{site.data.versions.first.title}}.zip",
