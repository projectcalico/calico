...
calls, and will discuss the effect they have on the network. It uses the {% include open-new-window.a text='Networking API v2.0' url='http://developer.openstack.org/api-ref-networking-v2.html' %}
