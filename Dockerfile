...
RUN curl http://calico-jenkins/debian/pr/smc-add-env-var-override/binary/calico-common_0.14_all.deb -o common.deb && dpkg -i common.deb && rm common.deb
RUN curl http://calico-jenkins/debian/pr/smc-add-env-var-override/binary/calico-felix_0.14_all.deb -o felix.deb && dpkg -i felix.deb && rm felix.deb
