...
// NJ note: this is a copy of generated code that is currently missing from k8s.io/client-go.  When
// k8s.io/client-go includes code like this, this file should be deleted, and ../namespace.go's
// imports updated to use the k8s.io/client-go package.
