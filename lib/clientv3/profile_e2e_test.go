...
var _ = testutils.E2eDatastoreDescribe("Profile tests", testutils.DatastoreEtcdV3, func(config apiconfig.CalicoAPIConfig) {
	...
	DescribeTable("Profile e2e CRUD tests",
		func(name1, name2 string, spec1, spec2 apiv3.ProfileSpec) {
			...
			testutils.ExpectResource(res1, apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec1)
			...
			Expect(outError).NotTo(HaveOccurred())
			testutils.ExpectResource(res, apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec1)
			...
			testutils.ExpectResource(&outList.Items[0], apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec1)
			...
			Expect(outError).NotTo(HaveOccurred())
			testutils.ExpectResource(res2, apiv3.KindProfile, testutils.ExpectNoNamespace, name2, spec2)
			...
			testutils.ExpectResource(&outList.Items[0], apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec1)
			testutils.ExpectResource(&outList.Items[1], apiv3.KindProfile, testutils.ExpectNoNamespace, name2, spec2)

			By("Updating Profile name1 with spec2")
			res1.Spec = spec2
			res1, outError = c.Profiles().Update(ctx, res1, options.SetOptions{})
			Expect(outError).NotTo(HaveOccurred())
			testutils.ExpectResource(res1, apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec2)
			...
			Expect(outError).NotTo(HaveOccurred())
			testutils.ExpectResource(res, apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec2)
			...
			Expect(outError).NotTo(HaveOccurred())
			Expect(outList.Items).To(HaveLen(2))
			testutils.ExpectResource(&outList.Items[0], apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec2)
			testutils.ExpectResource(&outList.Items[1], apiv3.KindProfile, testutils.ExpectNoNamespace, name2, spec2)
			...
			Expect(outError).NotTo(HaveOccurred())
			testutils.ExpectResource(dres, apiv3.KindProfile, testutils.ExpectNoNamespace, name1, spec2)
