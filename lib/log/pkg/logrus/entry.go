...
func (e *entry) WithError(err error) log.Entry {
	return &entry{e.entry.WithError(err)}
}

func (e *entry) WithContext(ctx context.Context) log.Entry {
	return &entry{e.entry.WithContext(ctx)}
}

func (e *entry) WithField(key string, value interface{}) log.Entry {
	return &entry{e.entry.WithField(key, value)}
}

func (e *entry) WithFields(fields log.Fields) log.Entry {
	return &entry{e.entry.WithFields(logrus.Fields(fields))}
}

func (e *entry) WithTime(t time.Time) log.Entry {
...
func (e entry) Log(level log.Level, args ...interface{}) {
...
func (e *entry) Logf(level log.Level, format string, args ...interface{}) {
...
func (e *entry) Logln(level log.Level, args ...interface{}) {
