...
var testCounter Counter = &countingCounter{}
...
func newBackgroundHookHarness(t *testing.T, _ string, opts ...BackgroundHookOpt) backgroundHookHarness {
	t.Helper()
	...
	bh := NewBackgroundHook(log.AllLevels, log.DebugLevel, []*Destination{testDest}, &countingCounter{}, opts...)
