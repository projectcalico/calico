...
import (
	...
	types "github.com/projectcalico/calico/lib/std/log/types"
)
...
func (_m *Context) Logger() types.Entry {
	ret := _m.Called()
	...
	var r0 types.Entry
	if rf, ok := ret.Get(0).(func() types.Entry); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.Entry)
		}
	}
