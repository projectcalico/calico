...
// callerInfo returns the file basename and line number of the user code that
// invoked the log call. It walks the stack itself rather than trusting
// entry.Caller because the wrapper types in this package would otherwise be
