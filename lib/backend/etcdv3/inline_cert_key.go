...
// This code has been borrowed from etcd repository and has been modified
...
// clientConfig() returns a config file with certificate data for client creation
// using only the inline certificate, key and CA certificate data.
