...
type WorkloadEndpointSpec struct {
	...
	// AllowSpoofedSourceIPs is a list of IP addresses this workload endoint is allowed to send traffic from,
	// i.e. this allows the workload endpoint to spoof its IP address using these addresses
