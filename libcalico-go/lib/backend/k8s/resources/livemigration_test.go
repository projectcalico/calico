	...
	Describe("Get", func() {
		It("converts a matching VMIM to a LiveMigration with spec populated", func() {
			...
			Expect(*lm.Spec.Target.Selector).To(Equal(
				"vmi.kubevirt.io/id == 'my-vmi' && kubevirt.io/migrationJobUID == 'uid-123'",
			))
			...
			BeforeEach(func() {
				...
				expectLiveMigration = func() {
					expectAndCheckEvent(func(e api.WatchEvent) {
						...
						Expect(*lm.Spec.Target.Selector).To(Equal("vmi.kubevirt.io/id == 'vm12' && kubevirt.io/migrationJobUID == 'c05275a7-f85b-42d5-a1d0-acdd49c26d57'"))
