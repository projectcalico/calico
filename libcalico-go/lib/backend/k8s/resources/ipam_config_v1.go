	...
	case *internalapi.IPAMConfig:
		...
		return &model.KVPair{
			...
			Value: &model.IPAMConfig{
				...
				MinIPReclaimAgeSeconds:       v3obj.Spec.MinIPReclaimAgeSeconds,
			},
	...
	case *v3.IPAMConfiguration:
		...
		return &model.KVPair{
			...
			Value: &model.IPAMConfig{
				...
				KubeVirtVMAddressPersistence: kubeVirtVMAddressPersistence,
				MinIPReclaimAgeSeconds:       int(v3obj.Spec.MinIPReclaimAgeSeconds),
			},
			Revision: kvp.Revision,
			UID:      &v3obj.UID,
		}, nil
		...
		return &model.KVPair{
			...
			Value: &v3.IPAMConfiguration{
				...
				Spec: v3.IPAMConfigurationSpec{
					...
					KubeVirtVMAddressPersistence: kubeVirtVMAddressPersistence,
					MinIPReclaimAgeSeconds:       int32(v1obj.MinIPReclaimAgeSeconds),
				},
			},
		...
		return &model.KVPair{
			...
			Value: &internalapi.IPAMConfig{
				...
				Spec: internalapi.IPAMConfigSpec{
					...
					KubeVirtVMAddressPersistence: kubeVirtVMAddressPersistence,
					MinIPReclaimAgeSeconds:       v1obj.MinIPReclaimAgeSeconds,
				},
			},
			Revision: kvpv1.Revision,
		}
