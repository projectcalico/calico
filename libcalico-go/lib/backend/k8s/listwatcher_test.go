...
func TestNewListWatcher(t *testing.T) {
	...
	assert.True(t, lw.needsInitialSync)
...
func TestListWatcher_OnListSuccess(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
	...
	assert.False(t, lw.needsInitialSync)
}

// ============================================================================
// ShouldPerformFullResync Tests
// ============================================================================

func TestListWatcher_ShouldPerformFullResync_Initial(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
	...
	// Initial state: needsInitialSync=true, CurrentRevision="0"
	assert.True(t, lw.ShouldPerformFullResync())
}

func TestListWatcher_ShouldPerformFullResync_NeedsSync(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
...
func TestListWatcher_ShouldPerformFullResync_RevisionZero(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
...
func TestListWatcher_ShouldPerformFullResync_NoResyncNeeded(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
	...
	assert.False(t, lw.ShouldPerformFullResync())
}

// ============================================================================
// GetSyncStrategy Tests
// ============================================================================

func TestListWatcher_GetSyncStrategy_WatchList(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
	...
	strategy := lw.GetSyncStrategy()

	_, isWatchList := strategy.(api.WatchListStrategy)
	assert.True(t, isWatchList)
}

func TestListWatcher_GetSyncStrategy_ListThenWatch(t *testing.T) {
	client := &mockK8sResourceClient{}
	list := testListOptions()
	handler := newMockEventHandler()
	...
	_, isListThenWatch := strategy.(api.ListThenWatchStrategy)
	assert.True(t, isListThenWatch)
}
...
func TestListWatcher_HandleBookmark_WithoutInitialEventsAnnotation(t *testing.T) {
	...
	assert.True(t, lw.needsInitialSync)   // Still needs initial sync
}
...
func TestListWatcher_FullListThenWatch_Flow(t *testing.T) {
	...
	// Perform the initial sync using ListThenWatch strategy
	strategy := lw.GetSyncStrategy()
	err := strategy.PerformInitialSync(context.Background(), lw.GenericListWatcher, lw)
...
func TestListWatcher_WatchListMode_Flow(t *testing.T) {
	...
	// Perform the initial sync using WatchList strategy
	strategy := lw.GetSyncStrategy()
	err := strategy.PerformInitialSync(context.Background(), lw.GenericListWatcher, lw)
	...
	assert.True(t, lw.needsInitialSync)   // Still true until bookmark received
}
