...
func TestListWatcher_OnListSuccess(t *testing.T) {
	...
	// OnListSuccess is a no-op for etcd, should not panic
	lw.OnListSuccess()

	// No specific assertions, just verifying it doesn't panic
}
...
func TestListWatcher_ShouldPerformFullResync_Initial(t *testing.T) {
	...
	// Initial state: CurrentRevision="0"
	assert.True(t, lw.ShouldPerformFullResync())
}

func TestListWatcher_ShouldPerformFullResync_WithRevision(t *testing.T) {
	list := testListOptions()
	handler := newMockEventHandler()
...
func TestListWatcher_ShouldPerformFullResync_AfterReset(t *testing.T) {
	list := testListOptions()
	handler := newMockEventHandler()
...
func TestListWatcher_GetSyncStrategy(t *testing.T) {
	list := testListOptions()
	handler := newMockEventHandler()
	...
	// etcd always uses ListThenWatchStrategy
	_, isListThenWatch := strategy.(api.ListThenWatchStrategy)
	assert.True(t, isListThenWatch)
}

// ============================================================================
// Integration-like Tests with Strategy
// ============================================================================

func TestListWatcher_ListThenWatchStrategy_PerformInitialSync(t *testing.T) {
	list := testListOptions()
	handler := newMockEventHandler()
	...
	// We can't fully test PerformInitialSync without a real client,
	// but we can verify the strategy is correct
	strategy := lw.GetSyncStrategy()
