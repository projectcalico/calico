...
func parseRawString(key Key, rawData []byte) (string, error) {
	return string(rawData), nil
}

func parseRawBool(key Key, rawData []byte) (bool, error) {
	return string(rawData) == "true", nil
}

func parseRawIP(key Key, rawData []byte) (*net.IP, error) {
