...
func init() {
	...
	DescribeTable("Validator",
		...
		Entry("should accept valid route table range", api.FelixConfigurationSpec{RouteTableRanges: &api.RouteTableRanges{api.RouteTableRange{Min: 1, Max: 250}}}, true),
		Entry("should reject route table range min too small", api.FelixConfigurationSpec{RouteTableRanges: &api.RouteTableRanges{api.RouteTableRange{Min: 0, Max: 250}}}, false),
		Entry("should reject route table range min negative", api.FelixConfigurationSpec{RouteTableRanges: &api.RouteTableRanges{api.RouteTableRange{Min: -5, Max: 250}}}, false),
		Entry("should reject route table range max < min", api.FelixConfigurationSpec{RouteTableRanges: &api.RouteTableRanges{api.RouteTableRange{Min: 50, Max: 45}}}, false),
		Entry("should reject route table range max too large", api.FelixConfigurationSpec{RouteTableRanges: &api.RouteTableRanges{api.RouteTableRange{Min: 1, Max: 253}}}, false),
		Entry("should accept route table range with min == max", api.FelixConfigurationSpec{RouteTableRanges: &api.RouteTableRanges{api.RouteTableRange{Min: 8, Max: 8}}}, true),
