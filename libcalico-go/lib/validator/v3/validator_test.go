...
func init() {
	...
	var iptablesBackendLegacy, iptablesBackendNFTables, iptablesBackendAuto,
		iptablesBackendbadVal api.IptablesBackend

	iptablesBackendLegacy = api.IptablesBackendLegacy
	iptablesBackendNFTables = api.IptablesBackendNFTables
	iptablesBackendAuto = api.IptablesBackendAuto
