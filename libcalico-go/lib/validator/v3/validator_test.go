...
func init() {
	...
	DescribeTable("Validator",
		...
		Entry("invalid route priority 0", api.FelixConfigurationSpec{IPv4ElevatedRoutePriority: intPtr(0)}, false),
		Entry("valid route priority 1", api.FelixConfigurationSpec{IPv4ElevatedRoutePriority: intPtr(1)}, true),
		Entry("valid route priority 10000", api.FelixConfigurationSpec{IPv4ElevatedRoutePriority: intPtr(10000)}, true),
		Entry("valid route priority 2147483646", api.FelixConfigurationSpec{IPv4ElevatedRoutePriority: intPtr(2147483646)}, true),
		Entry("invalid route priority 2147483647", api.FelixConfigurationSpec{IPv4ElevatedRoutePriority: intPtr(2147483647)}, false),
