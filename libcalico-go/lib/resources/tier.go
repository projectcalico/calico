...
func DefaultTierFields(res *apiv3.Tier) {
	...
	// For the implementation of BaselineAdminNetworkPolicy, we needed to add a tier
	// after the default one. As such, the default tier order changed to 100,000 from ni.
