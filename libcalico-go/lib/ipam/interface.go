...
type Interface interface {
	...
	ClaimAffinity(ctx context.Context, cidr cnet.IPNet, affinityCfg model.AffinityConfig) ([]cnet.IPNet, []cnet.IPNet, error)
	...
	ReleaseHostAffinities(ctx context.Context, affinityCfg model.AffinityConfig, mustBeEmpty bool) error
	...
	RemoveIPAMHost(ctx context.Context, affinityCfg model.AffinityConfig) error
