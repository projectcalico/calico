...
const (
	...
	AdminNetworkTierName       = "adminNetworkPolicy"
	PolicyBaselineTierName     = "policyBaseline"
...
// ValidateTierName checks if tier name used in a resource is a valid one.
func ValidateTierName(tier string) bool {
	return (tier == DefaultTierName || tier == AdminNetworkTierName || tier == PolicyBaselineTierName)
}
