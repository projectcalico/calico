...
var _ = DescribeTable("Parse Tiered policy name",
	...
	Entry("K8s cluster network policy (admin tier)", "kcnp.admin.barpolicy", false, "admin"),
	Entry("K8s cluster network policy (baseline tier)", "kcnp.baseline.barpolicy", false, "baseline"),
...
var _ = DescribeTable("Backend Tiered policy name",
	...
	Entry("K8s Cluster Network Policy (admin tier) and empty tier", "kcnp.admin.foobar", "", false, "kcnp.admin.foobar"),
	Entry("K8s Cluster Network Policy (baseline tier) and empty tier", "kcnp.baseline.foobar", "", false, "kcnp.baseline.foobar"),
...
var _ = DescribeTable("Tiered policy name",
	...
	Entry("K8s cluster network policy (admin tier)", "kcnp.admin.foopolicy", "kcnp.admin.foopolicy"),
	Entry("K8s cluster network policy (baseline tier)", "kcnp.baseline.foopolicy", "kcnp.baseline.foopolicy"),
)
...
var _ = DescribeTable("Client Tiered policy name",
	...
	Entry("K8s Cluster Network Policy (admin tier)", "kcnp.admin.bazpolicy", false, "kcnp.admin.bazpolicy"),
	Entry("K8s Cluster Network Policy (baseline tier)", "kcnp.baseline.bazpolicy", false, "kcnp.baseline.bazpolicy"),
)
