---
title: Calico Policy for Kubernetes
---
...
## Next Steps
- Install the [policy tool](https://github.com/projectcalico/k8s-policy) for easy management of NetworkPolicy objects.

- Once you have enabled network policy on your cluster and configured Calico to use the Kubernetes network policy API, you can deploy our [Kubernetes policy example application](stars-demo/index).
