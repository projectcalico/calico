...
To create a Kubernetes cluster which supports the Kubernetes v1beta1 network policy API, follow our [Vagrant CoreOS guide](../vagrant-coreos/VagrantCoreOS.md).
