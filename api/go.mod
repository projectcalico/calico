...
replace (
	...
	k8s.io/code-generator => k8s.io/code-generator v0.33.12
	k8s.io/component-base => k8s.io/component-base v0.33.12
	k8s.io/component-helpers => k8s.io/component-helpers v0.33.12
	k8s.io/controller-manager => k8s.io/controller-manager v0.33.12
	k8s.io/cri-api => k8s.io/cri-api v0.33.12
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.33.12
	k8s.io/externaljwt => k8s.io/externaljwt v0.33.12
	k8s.io/kube-aggregator => k8s.io/kube-aggregator v0.33.12
	k8s.io/kube-controller-manager => k8s.io/kube-controller-manager v0.33.12
	k8s.io/kube-proxy => k8s.io/kube-proxy v0.33.12
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.33.12
	k8s.io/kubectl => k8s.io/kubectl v0.33.12
	k8s.io/kubelet => k8s.io/kubelet v0.33.12
	...
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.33.12
)
