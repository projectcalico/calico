...
type FelixConfigurationSpec struct {
	...
	// VXLANMTU is the MTU to set on the IPv4 VXLAN tunnel device. See Configuring MTU [Default: 1440]
	VXLANMTU *int `json:"vxlanMTU,omitempty"`
	// VXLANV6MTU is the MTU to set on the IPv6 VXLAN tunnel device. See Configuring MTU [Default: 1420]
	VXLANV6MTU *int `json:"vxlanV6MTU,omitempty"`
