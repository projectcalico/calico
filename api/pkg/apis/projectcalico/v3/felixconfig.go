...
type FelixConfigurationSpec struct {
	...
	// Max entries allowed in a single IP set.
	// +optional
	...
	// IPIPMTU is the MTU to set on the tunnel device. If not set, will be automatically detected.
	// +optional
	IPIPMTU *int `json:"ipipMTU,omitempty" confignamev1:"IpInIpMtu"`

	// VXLANMTU is the MTU to set on the tunnel device. If not set, will be automatically detected.
	// +optional
