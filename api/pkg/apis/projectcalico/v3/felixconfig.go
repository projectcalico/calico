...
type FelixConfigurationSpec struct {
	...
	// +kubebuilder:validation:Pattern="^([a-zA-Z]+=(true|false|),)*([a-zA-Z]+=(true|false|))$"
	...
	// +kubebuilder:validation:Pattern="^([a-zA-Z]+=(enabled|disabled|true|false),)*([a-zA-Z]+=(enabled|disabled|true|false))$"
	...
	// +kubebuilder:validation:Type=string
	// +kubebuilder:validation:Enum=Auto;FelixConfiguration;FelixConfigurationList;Legacy;NFT
	...
	// +kubebuilder:validation:Enum=Off;Info;Debug
	...
	// +kubebuilder:validation:Enum=Tunnel;DSR
	...
	// +kubebuilder:validation:Enum=Disabled;Strict;Loose
	...
	// +kubebuilder:validation:Enum=WorkloadIPs;CalicoIPAM
	...
	// +kubebuilder:validation:Enum=Disabled;Any
