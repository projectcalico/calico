...
type FelixConfigurationSpec struct {
	...
	// BPFMapSizePerCPUConntrack determines the size of connectrack map based on the number of CPUs. If set it to a
	// non-zero value, BPFMapSizeConntrack will be override as BPFMapSizePerCPUConntrack * (Number of CPUs).
