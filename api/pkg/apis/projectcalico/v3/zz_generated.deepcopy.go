...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BGPFilterPrefixLength) DeepCopyInto(out *BGPFilterPrefixLength) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BGPFilterPrefixLength.
func (in *BGPFilterPrefixLength) DeepCopy() *BGPFilterPrefixLength {
	if in == nil {
		return nil
	}
	out := new(BGPFilterPrefixLength)
	in.DeepCopyInto(out)
	return out
}
