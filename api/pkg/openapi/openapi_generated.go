		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"bindMode": {
						SchemaProps: spec.SchemaProps{
							Description: "BindMode indicates whether to listen for BGP connections on all addresses (None) or only on the node's canonical IP address Node.Spec.BGP.IPvXAddress (NodeIP).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
