		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"logSeverityFile": {
						SchemaProps: spec.SchemaProps{
							Description: "LogSeverityFile is the log severity above which logs are sent to the log file. [Default: Info] kubebuilder:validation:Enum=Debug,Info,Warning,Error,Fatal",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"logSeverityScreen": {
						SchemaProps: spec.SchemaProps{
							Description: "LogSeverityScreen is the log severity above which logs are sent to the stdout. [Default: Info] kubebuilder:validation:Enum=Debug,Info,Warning,Error,Fatal",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"logSeveritySys": {
						SchemaProps: spec.SchemaProps{
							Description: "LogSeveritySys is the log severity above which logs are sent to the syslog. Set to None for no logging to syslog. [Default: Info] kubebuilder:validation:Enum=Debug,Info,Warning,Error,Fatal",
							Type:        []string{"string"},
							Format:      "",
						},
					},
