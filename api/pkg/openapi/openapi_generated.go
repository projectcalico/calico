		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"featureGates": {
						SchemaProps: spec.SchemaProps{
							Description: "FeatureGate is used to enable or disable tech-preview Calico features. Values are specified in a comma separated list with no spaces, example; \"BPFConnectTimeLoadBalancingWorkaround=enabled,XyZ=false\". This is used to enable featureis that are not fully production ready.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
