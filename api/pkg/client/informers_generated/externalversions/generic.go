...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v3.SchemeGroupVersion.WithResource("ipamconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().IPAMConfigs().Informer()}, nil
