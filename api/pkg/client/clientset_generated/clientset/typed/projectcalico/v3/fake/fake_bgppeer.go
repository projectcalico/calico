...
func (c *FakeBGPPeers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.BGPPeer, err error) {
	emptyResult := &v3.BGPPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootGetActionWithOptions(bgppeersResource, name, options), emptyResult)
	if obj == nil {
...
func (c *FakeBGPPeers) List(ctx context.Context, opts v1.ListOptions) (result *v3.BGPPeerList, err error) {
	emptyResult := &v3.BGPPeerList{}
	obj, err := c.Fake.
		Invokes(testing.NewRootListActionWithOptions(bgppeersResource, bgppeersKind, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
...
func (c *FakeBGPPeers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchActionWithOptions(bgppeersResource, opts))
}
...
func (c *FakeBGPPeers) Create(ctx context.Context, bGPPeer *v3.BGPPeer, opts v1.CreateOptions) (result *v3.BGPPeer, err error) {
	emptyResult := &v3.BGPPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateActionWithOptions(bgppeersResource, bGPPeer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.BGPPeer), err
...
func (c *FakeBGPPeers) Update(ctx context.Context, bGPPeer *v3.BGPPeer, opts v1.UpdateOptions) (result *v3.BGPPeer, err error) {
	emptyResult := &v3.BGPPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateActionWithOptions(bgppeersResource, bGPPeer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.BGPPeer), err
...
func (c *FakeBGPPeers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionActionWithOptions(bgppeersResource, opts, listOpts)
...
func (c *FakeBGPPeers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.BGPPeer, err error) {
	emptyResult := &v3.BGPPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceActionWithOptions(bgppeersResource, name, pt, data, opts, subresources...), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.BGPPeer), err
