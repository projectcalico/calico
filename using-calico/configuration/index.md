...
Red Hat, please see our [Ubuntu]({{site.url}}/getting-started/openstack/installation/ubuntu) or [Red Hat]({{site.url}}/getting-started/openstack/installation/redhat)  installation guides.
...
The core Calico component is Felix. (Please see [this document]({{site.url}}/reference/architecture) for more on  the Calico architecture.)
