...
[AS Per Rack model]({{site.url}}/reference/private-cloud/l3-interconnect-fabric)
...
[AS per rack model]({{site.url}}/reference/private-cloud/l3-interconnect-fabric)
or
[AS per Compute Server model]({{site.url}}/reference/private-cloud/l2-interconnect-fabric)
