...
timestamp detailing when the files was rotated in {% include open-new-window.html text='tai64n' url='http://cr.yp.to/libtai/tai64.html#tai64n' %} format.

All logging is done using {% include open-new-window.html text='svlogd' url='http://smarden.org/runit/svlogd.8.html' %}.
...
and to filter logs.
See the {% include open-new-window.html text='documentation' url='http://smarden.org/runit/svlogd.8.html' %} for further details.
...
{% include open-new-window.html text='documentation' url='https://github.com/kelseyhightower/confd/blob/master/docs/configuration-guide.md' %}
