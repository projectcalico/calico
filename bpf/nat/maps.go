...
func (v FrontendValue) AffinityTimeout() uint32 {
	return binary.LittleEndian.Uint32(v[12:16])
}
...
func (v AffinityValue) Timestamp() uint64 {
	return binary.LittleEndian.Uint64(v[backendValueSize : backendValueSize+8])
}
