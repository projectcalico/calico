...
func toLogrusFields(keysAndValues ...any) log.Fields {
	fields := log.Fields{}
...
func configureLogging() {
	...
	// create a logger to be used by klog
	logrusLogger := log.New("apiserver").WithField("klog-logger", "tigera-apiserver")
	log.SetLevel(logrusLevel())
