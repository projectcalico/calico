...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	apiserver, ok := obj.(*calico.BGPPeer)
	if !ok {
...
func MatchBGPPeer(label labels.Selector, field fields.Selector) storage.SelectionPredicate {
...
// BGPPeerToSelectableFields returns a field set that represents the object.
func BGPPeerToSelectableFields(obj *calico.BGPPeer) fields.Set {
