...
func NewIPReservationStorage(opts Options) (registry.DryRunnableStorage, factory.DestroyFunc) {
	...
	dryRunnableStorage := registry.DryRunnableStorage{Storage: &resourceStore{
		...
		aapiType:          reflect.TypeFor[api.IPReservation](),
		aapiListType:      reflect.TypeFor[api.IPReservationList](),
		libCalicoType:     reflect.TypeFor[api.IPReservation](),
		libCalicoListType: reflect.TypeFor[api.IPReservationList](),
		isNamespaced:      false,
		create:            createFn,
		update:            updateFn,
		get:               getFn,
