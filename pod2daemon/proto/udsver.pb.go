...
var file_udsver_proto_rawDesc = []byte{
...
var (
	...
	file_udsver_proto_rawDescData = file_udsver_proto_rawDesc
)

func file_udsver_proto_rawDescGZIP() []byte {
	file_udsver_proto_rawDescOnce.Do(func() {
		file_udsver_proto_rawDescData = protoimpl.X.CompressGZIP(file_udsver_proto_rawDescData)
	})
...
func file_udsver_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_udsver_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_udsver_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_udsver_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_udsver_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
