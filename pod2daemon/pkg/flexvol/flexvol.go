...
// Capabilities describes the driver capabilities reported to kubelet.
...
// initConfiguration reads the configuration file if available and initializes the
// configuration options of the driver.
