...
func TestMaxPacketOffset(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeB), K: 0},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeB), K: 10},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeH), K: 12},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeW), K: 20},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeB), K: 10}, // offset 11
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeW), K: 50}, // offset 54
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeH), K: 30}, // offset 32
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeIND | bpfSizeB), K: 0},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLd | bpfModeIND | bpfSizeW), K: 10},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassLdx | bpfModeMSH | bpfSizeB), K: 14},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				...
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeB), K: 23},
				// Load destination port (2 bytes) at IP header + 2
				{Code: uint16(bpfClassLd | bpfModeIND | bpfSizeH), K: 2},
			},
		...
		},
		{
			...
			insns: []pcap.BPFInstruction{
				{Code: uint16(bpfClassJmp), K: 0},   // jump instruction
				{Code: uint16(bpfClassRet), K: 100}, // return instruction
				{Code: uint16(bpfClassLd | bpfModeABS | bpfSizeB), K: 5},
			},
