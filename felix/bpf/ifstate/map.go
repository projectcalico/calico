...
func NewValue(
	...
	binary.LittleEndian.PutUint16(v[4+16+36:4+16+44], uint16(ingressPacketRateLastUpdate))
	binary.LittleEndian.PutUint16(v[4+16+44:4+16+52], uint16(egressPacketRateLastUpdate))
