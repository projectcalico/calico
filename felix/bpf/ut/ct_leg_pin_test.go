...
// TestCtLegPinIfaceEncaps pins the provenance side of the tunnel claim: the
// attach point's IFACE_ENCAPS global decides, not the compiled object, which
// wireguard shares with a plain L3-classified NIC.
