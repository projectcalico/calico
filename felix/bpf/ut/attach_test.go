...
func TestAttach(t *testing.T) {
	...
	t.Run("create first host endpoint with untracked (xdp) policy", func(t *testing.T) {
		bpfEpMgr.OnUpdate(linux.NewIfaceUpdate("hostep1", ifacemonitor.StateUp, host1.Attrs().Index))
	...
	t.Run("create a workload", func(t *testing.T) {
		bpfEpMgr.OnUpdate(linux.NewIfaceUpdate("workloadep1", ifacemonitor.StateUp, workload1.Attrs().Index))
	...
	t.Run("bring first host ep down, should clean up its policies", func(t *testing.T) {
		bpfEpMgr.OnUpdate(linux.NewIfaceUpdate("hostep1", ifacemonitor.StateDown, host1.Attrs().Index))
	...
	t.Run("bring first workload iface down, should clean up its policies", func(t *testing.T) {
		bpfEpMgr.OnUpdate(linux.NewIfaceUpdate("workloadep1", ifacemonitor.StateDown, host1.Attrs().Index))
	...
	t.Run("restart", func(t *testing.T) {
		...
		bpfEpMgr.OnUpdate(linux.NewIfaceUpdate("workloadep3", ifacemonitor.StateUp, workload3.Attrs().Index))
