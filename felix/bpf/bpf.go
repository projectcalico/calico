...
func isAtLeastKernel(v *detector.Version) error {
...
func GetMinKernelVersionForDistro(distName string) *detector.Version {
	return distToVersionMap[distName]
}

func SupportsBPFDataplane() error {
	distName := detector.GetDistributionName()
