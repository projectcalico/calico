...
var (
	...
	zombieEOTDenyHit = calc.NewRuleID("default", "", "",
	...
	zombiePolicyAllow = calc.NewRuleID("default", "policy1", "",
	...
	zombieUnknownPolicyAllow = calc.NewRuleID("default", "policy-new", "",
...
func newZombieTestEp() *calc.LocalEndpointData {
	eotDeny := calc.NewRuleID("default", "policy2", "",
