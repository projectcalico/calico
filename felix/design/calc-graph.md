...
[`design/MAINTAINING.md`](../../design/MAINTAINING.md) governs edits to
this file: **the default is no edit**, and an edit that does belong is
normally one to three lines in a section that is already there — never a
paraphrase of the commit message. It is mirrored in
