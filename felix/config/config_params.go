...
type Config struct {
	...
	BPFDataIfacePattern                *regexp.Regexp   `config:"regexp;^((en|wl|ww|sl|ib)[opsx].*|(eth|wlan|wwan).*|tunl0$|vxlan.calico$)"`
	BPFL3IfacePattern                  *regexp.Regexp   `config:"regexp;^(wireguard.cali$|wg-v6.cali$)"`
