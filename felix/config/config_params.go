...
type Config struct {
	...
	WireguardInterfaceNameV6       string        `config:"iface-param;wireguard-v6.cali;non-zero"`
	...
	BPFDataIfacePattern                *regexp.Regexp   `config:"regexp;^((en|wl|ww|sl|ib)[opsx].*|(eth|wlan|wwan).*|tunl0$|vxlan.calico$|wireguard.cali$|wireguard-v6.cali$)"`
