...
var _ = Describe("FelixConfig vs ConfigParams parity", func() {
	...
	cpFieldNameToFC := map[string]string{
		...
		"IptablesLockTimeout":         "IptablesLockTimeout",
		"IptablesLockProbeInterval":   "IptablesLockProbeInterval",
		"IptablesPostWriteCheckInterval": "IptablesPostWriteCheckInterval",
		"NetlinkTimeout":              "NetlinkTimeout",
		"ReportingInterval":           "ReportingInterval",
		"ReportingTTL":                "ReportingTTL",
		"UsageReportingInitialDelay":  "UsageReportingInitialDelay",
		"UsageReportingInterval":      "UsageReportingInterval",
		"EndpointReportingDelay":      "EndpointReportingDelay",
	}
...
var _ = DescribeTable("Config parsing",
	...
	Entry("Netlink Timeout - default value", "NetlinkTimeout", "", time.Duration(10*time.Second), false),
	...
	Entry("IptablesPostWriteCheckInterval", "IptablesPostWriteCheckInterval",
		"1.5", 1500*time.Millisecond),
	Entry("IptablesLockFilePath", "IptablesLockFilePath",
		"/host/run/xtables.lock", "/host/run/xtables.lock"),
	Entry("IptablesLockTimeout", "IptablesLockTimeout",
		"123", 123*time.Second),
	Entry("IptablesLockProbeInterval", "IptablesLockProbeInterval",
		"123", 123*time.Millisecond),
	Entry("IptablesLockProbeInterval garbage", "IptablesLockProbeInterval",
	...
	Entry("ReportingInterval", "ReportingInterval", "31", 31*time.Second),
	Entry("ReportingTTL", "ReportingTTL", "91", 91*time.Second),

	Entry("EndpointReportingEnabled", "EndpointReportingEnabled",
		"true", true),
	Entry("EndpointReportingEnabled", "EndpointReportingEnabled",
		"yes", true),
	Entry("EndpointReportingDelay", "EndpointReportingDelay",
		"10", 10*time.Second),
