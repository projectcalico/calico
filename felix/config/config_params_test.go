...
var _ = DescribeTable("Config parsing",
	...
	Entry("BPFFlags Empty", "BPFFlags", "", []string(nil)),
	Entry("BPFFlags Single valid entry", "BPFFlags", "test-flag", []string{"test-flag"}),
	Entry("BPFFlags Multiple valid entries", "BPFFlags", "flag1,test-flag,123-abc", []string{"flag1", "test-flag", "123-abc"}),
	Entry("BPFFlags Valid with numbers", "BPFFlags", "flag123,test456", []string{"flag123", "test456"}),
	Entry("BPFFlags Valid with dashes", "BPFFlags", "test-flag-123,another-flag", []string{"test-flag-123", "another-flag"}),
	Entry("BPFFlags Invalid with uppercase", "BPFFlags", "INVALID", []string(nil)),
	Entry("BPFFlags Invalid with special chars", "BPFFlags", "test@flag", []string(nil)),
	Entry("BPFFlags Invalid with underscore", "BPFFlags", "test_flag", []string(nil)),
	Entry("BPFFlags Mixed valid and invalid", "BPFFlags", "valid-flag,INVALID", []string(nil)),
