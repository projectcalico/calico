...
struct
{
	...
	__uint(key_size, sizeof(union ip4_set_lpm_key));
	__uint(value_size, sizeof(__u32));
	__uint(max_entries, 1024 * 1024);
	__uint(map_flags, BPF_F_NO_PREALLOC);
} cali_v4_ip_sets SEC(".maps");
//CALI_MAP_V1(cali_v4_ip_sets, BPF_MAP_TYPE_LPM_TRIE, sizeof(union ip4_set_lpm_key), sizeof(__u32), 1024*1024, BPF_F_NO_PREALLOC)
	/*
