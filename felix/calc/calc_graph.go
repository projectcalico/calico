...
func NewCalculationGraph(
	...
	// Encapsulation.NoEncapEnabled already accounts for ProgramClusterRoutes, but
	...
	if conf.BPFEnabled || conf.Encapsulation.VXLANEnabled || conf.Encapsulation.VXLANEnabledV6 ||
		conf.WireguardEnabled || conf.WireguardEnabledV6 || conf.Encapsulation.NoEncapEnabled ||
