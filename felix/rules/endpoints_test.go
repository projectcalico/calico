		...
		Context("with normal config", func() {
			...
			It("should render a minimal workload endpoint", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					...
					nil,
					nil,
					false)).To(Equal(trimSMChain(kubeIPVSEnabled, []*generictables.Chain{
					{
			...
			It("should render a minimal workload endpoint with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234", epMarkMapper,
					true,
					nil,
					nil, true)).To(Equal(trimSMChain(kubeIPVSEnabled, []*generictables.Chain{
					{
						Name: "cali-tw-cali1234",
						Rules: []generictables.Rule{
							// conntrack rules.
			...
			It("should render a disabled workload endpoint with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234", epMarkMapper,
					false,
					nil,
			...
			It("should render a fully-loaded workload endpoint with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234",
					epMarkMapper,
					true,
			...
			It("should render a workload endpoint with policy groups with flowlogs", func() {
				format.MaxLength = 1000000
			...
			It("should render a fully-loaded workload endpoint - one staged policy, one enforced with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234",
					epMarkMapper,
					true,
			...
			It("should render a fully-loaded workload endpoint - both staged, end-of-tier action is pass with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234",
					epMarkMapper,
					true,
			...
			It("should render a fully-loaded workload endpoint - staged policy group, end-of-tier pass with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234",
					epMarkMapper,
					true,
			...
			It("should render a fully-loaded workload endpoint with tier DefaultAction is Pass with flowlogs", func() {
				Expect(renderer.WorkloadEndpointToIptablesChains(
					"cali1234",
					epMarkMapper,
					true,
			...
			It("should render a host endpoint with flowlogs", func() {
				actual := renderer.HostEndpointToFilterChains("eth0",
					tiersToSinglePolGroups([]*proto.TierInfo{{
						Name:            "default",
						IngressPolicies: []string{"ai", "bi"},
			...
			It("should render host endpoint raw chains with untracked policies with flowlogs", func() {
				Expect(renderer.HostEndpointToRawChains("eth0",
					tiersToSinglePolGroups([]*proto.TierInfo{{
						Name:            "default",
						IngressPolicies: []string{"c"},
			...
			It("should render host endpoint mangle chains with pre-DNAT policies with flowlogs", func() {
				Expect(renderer.HostEndpointToMangleIngressChains(
					"eth0",
					tiersToSinglePolGroups([]*proto.TierInfo{{
						Name:            "default",
