...
configRetry:
	...
	loadDatastoreRetry:
		...
		typhaDiscoverer = createTyphaDiscoverer(configParams, k8sClientSet, v3Client)
...
func createTyphaDiscoverer(configParams *config.Config, k8sClientSet kubernetes.Interface, v3Client client.NodesClient) *discovery.Discoverer {
