...
| Encoding (env var/config file) | Comma-delimited list of key=value pairs |
| Default value (above encoding) | `CreationGracePeriod=10s,TCPSynSent=20s,TCPEstablished=1h,TCPFinsSeen=Auto,TCPResetSeen=10s,UDPTimeout=60s,GenericTimeout=10m,ICMPTimeout=5s` |
