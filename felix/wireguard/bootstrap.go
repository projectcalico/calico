...
func BootstrapAndFilterTyphaAddresses(
	...
	typhas, errV4 = bootstrapAndFilterTyphaAddressesForIPVersion(configParams, getNetlinkHandle, getWireguardHandle, calicoClient, typhas, 4)
	if errV4 != nil {
		errors = append(errors, fmt.Errorf("error bootstrapping IPv4 wireguard: %w", errV4))
	}

	typhas, errV6 = bootstrapAndFilterTyphaAddressesForIPVersion(configParams, getNetlinkHandle, getWireguardHandle, calicoClient, typhas, 6)
	if errV6 != nil {
