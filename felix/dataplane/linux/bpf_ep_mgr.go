...
func (i *bpfInterfaceState) hasJumps() bool {
	for _, h := range []hook.Hook{hook.XDP, hook.Ingress, hook.Egress} {
...
func NewBPFEndpointManager(
	...
	if m.bpfAttachType == apiv3.BPFAttachOptionNetkit {
		m.netkitAttachAllowed = true
		m.bpfAttachType = apiv3.BPFAttachOptionTCX
	}
