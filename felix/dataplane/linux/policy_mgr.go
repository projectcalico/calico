...
func newPolicyManager(rawTable, mangleTable, filterTable iptables.Table, ruleRenderer policyRenderer, ipVersion uint8) *policyManager {
...
func newRawEgressPolicyManager(rawTable iptables.Table, ruleRenderer policyRenderer, ipVersion uint8,
