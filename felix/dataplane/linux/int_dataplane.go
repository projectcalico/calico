...
func NewIntDataplaneDriver(config Config) *InternalDataplane {
	...
	bpfnat.SetMapSizes(config.BPFMapSizeNATFrontend, config.BPFMapSizeNATBackend, config.BPFMapSizeNATAffinity, config.BPFMapSizeConsistentHash)
