...
func NewIntDataplaneDriver(config Config) *InternalDataplane {
	...
	dp.RegisterManager(newMasqManager(ipSetsV4, natTableV4, mangleTableV4, ruleRenderer, config.MaxIPSetSize, 4))
	...
	if config.IPv6Enabled {
		...
		dp.RegisterManager(newMasqManager(ipSetsV6, natTableV6, mangleTableV6, ruleRenderer, config.MaxIPSetSize, 6))
