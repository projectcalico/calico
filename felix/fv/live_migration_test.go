...
const (
	...
	// Metric strings expected in "ip route show" output.  512 and 1024 are the defaults for
	// IPv4ElevatedRoutePriority and IPv4NormalRoutePriority.  Note that lower metric = more
	// preferred.
	lmElevatedMetric = "metric 512"
	lmNormalMetric   = "metric 1024"
...
var _ = infrastructure.DatastoreDescribe("live migration route programming; with 2 nodes",
...
// migration.
var _ = infrastructure.DatastoreDescribe("live migration route programming (KubeVirt); with 2 nodes",
	...
	func(getInfra infrastructure.InfraFactory) {
		...
		AfterEach(func() {
			...
			// VMIMs and the seeded IPAM allocation.
