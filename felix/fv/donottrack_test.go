		...
		BeforeEach(func() {
			...
			for _, felix := range tc.Felixes {
				Eventually(func() bool {
					return bpfCheckIfPolicyProgrammed(felix, "bond0", "egress", "allow-egress", "allow", false)
				}, "5s", "200ms").Should(BeTrue())

				Eventually(func() bool {
					return bpfCheckIfPolicyProgrammedV6(felix, "bond0", "egress", "allow-egress", "allow", false)
				}, "5s", "200ms").Should(BeTrue())
