...
var _ = infrastructure.DatastoreDescribe("pepper cluster network policy conversion _BPF-SAFE_", []apiconfig.DatastoreType{apiconfig.Kubernetes}, func(getInfra infrastructure.InfraFactory) {
	const wepPort = 8055
