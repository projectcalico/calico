...
type ConfigUpdate struct {
	...
	InternalOverrides map[string]string     `protobuf:"bytes,2,rep,name=internal_overrides,json=internalOverrides" json:"internal_overrides,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	SourceToRawConfig map[uint32]*RawConfig `protobuf:"bytes,3,rep,name=source_to_raw_config,json=sourceToRawConfig" json:"source_to_raw_config,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *ConfigUpdate) GetInternalOverrides() map[string]string {
	if m != nil {
		return m.InternalOverrides
	}
	return nil
}
...
func (*HostMetadataUpdate) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{41} }
...
func (*HostMetadataRemove) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{42} }
...
func (*IPAMPoolUpdate) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{45} }
...
func (*IPAMPoolRemove) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{46} }
...
func (*IPAMPool) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{47} }
...
func (*Encapsulation) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{48} }
...
func (*ServiceAccountRemove) Descriptor() ([]byte, []int) {
	return fileDescriptorFelixbackend, []int{50}
}
...
func (*ServiceAccountID) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{51} }
...
func (*NamespaceUpdate) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{52} }
...
func (*NamespaceRemove) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{53} }
...
func (*NamespaceID) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{54} }
...
func (*TunnelType) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{55} }
...
func (*RouteUpdate) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{56} }
...
func (*RouteRemove) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{57} }
...
func (*ServicePort) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{65} }
...
func (*ServiceUpdate) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{66} }
...
func (*ServiceRemove) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{67} }
...
func (m *ConfigUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.InternalOverrides) > 0 {
		for k, _ := range m.InternalOverrides {
			dAtA[i] = 0x12
			i++
			v := m.InternalOverrides[k]
			mapSize := 1 + len(k) + sovFelixbackend(uint64(len(k))) + 1 + len(v) + sovFelixbackend(uint64(len(v)))
			i = encodeVarintFelixbackend(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
func (m *ActiveProfileUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Profile != nil {
		...
		n46, err := m.Profile.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *ActivePolicyUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Policy != nil {
		...
		n49, err := m.Policy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *Rule) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Protocol != nil {
		...
		n51, err := m.Protocol.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if m.Icmp != nil {
		nn52, err := m.Icmp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn52
	...
	if m.NotProtocol != nil {
		...
		n53, err := m.NotProtocol.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
	...
	if m.NotIcmp != nil {
		nn54, err := m.NotIcmp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn54
	...
	if m.SrcServiceAccountMatch != nil {
		...
		n55, err := m.SrcServiceAccountMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n55
	...
	if m.DstServiceAccountMatch != nil {
		...
		n56, err := m.DstServiceAccountMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
	...
	if m.HttpMatch != nil {
		...
		n57, err := m.HttpMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
...
func (m *Rule_IcmpTypeCode) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IcmpTypeCode != nil {
		...
		n59, err := m.IcmpTypeCode.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n59
...
func (m *Rule_NotIcmpTypeCode) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NotIcmpTypeCode != nil {
		...
		n60, err := m.NotIcmpTypeCode.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n60
...
func (m *HTTPMatch_PathMatch) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.PathMatch != nil {
		nn61, err := m.PathMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn61
...
func (m *Protocol) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NumberOrName != nil {
		nn62, err := m.NumberOrName.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn62
...
func (m *IPAMPoolUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Pool != nil {
		...
		n75, err := m.Pool.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n75
...
func (m *RouteUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TunnelType != nil {
		...
		n80, err := m.TunnelType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n80
...
func (m *ConfigUpdate) Size() (n int) {
	...
	if len(m.InternalOverrides) > 0 {
		for k, v := range m.InternalOverrides {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovFelixbackend(uint64(len(k))) + 1 + len(v) + sovFelixbackend(uint64(len(v)))
			n += mapEntrySize + 1 + sovFelixbackend(uint64(mapEntrySize))
...
func (m *ConfigUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InternalOverrides", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InternalOverrides == nil {
				m.InternalOverrides = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.InternalOverrides[mapkey] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
var fileDescriptorFelixbackend = []byte{
	...
	,
}
