...
type WorkloadEndpoint struct {
	...
	LiveMigrationRole          LiveMigrationRole      `protobuf:"varint,16,opt,name=live_migration_role,json=liveMigrationRole,proto3,enum=felix.LiveMigrationRole" json:"live_migration_role,omitempty"`
	LiveMigrationUid           string                 `protobuf:"bytes,17,opt,name=live_migration_uid,json=liveMigrationUid,proto3" json:"live_migration_uid,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
const file_felixbackend_proto_rawDesc = "" +
	...
	"\aIngress\x18\x02 \x01(\bR\aIngress\"\xd0\x06\n" +
	...
	"\fqos_policies\x18\x0f \x03(\v2\x10.felix.QoSPolicyR\vqosPolicies\x12H\n" +
	"\x13live_migration_role\x18\x10 \x01(\x0e2\x18.felix.LiveMigrationRoleR\x11liveMigrationRole\x12,\n" +
	"\x12live_migration_uid\x18\x11 \x01(\tR\x10liveMigrationUid\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
