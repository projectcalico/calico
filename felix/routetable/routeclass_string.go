...
func _() {
	...
	_ = x[RouteClassTODO-6]
	_ = x[RouteClassMax-7]
}

const _RouteClass_name = "RouteClassLocalWorkloadRouteClassBPFSpecialRouteClassWireguardRouteClassVXLANSameSubnetRouteClassVXLANTunnelRouteClassIPAMBlockDropRouteClassTODORouteClassMax"

var _RouteClass_index = [...]uint8{0, 23, 43, 62, 87, 108, 131, 145, 158}
