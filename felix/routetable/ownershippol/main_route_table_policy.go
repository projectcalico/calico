...
func NewMainTable(
	...
	if deviceRouteProto == unix.RTPROT_BOOT {
		...
		allRouteProtos = []netlink.RouteProtocol{unix.RTPROT_BOOT, dataplanedefs.DefaultVXLANProto}
		exclusiveRouteProtos = []netlink.RouteProtocol{dataplanedefs.DefaultVXLANProto}
	} else {
