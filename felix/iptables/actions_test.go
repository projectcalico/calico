...
var _ = DescribeTable("Actions",
	...
	Entry("LimitNumConnectionsAction", environment.Features{}, LimitNumConnectionsAction{Num: 10, With: generictables.RejectWithTCPReset}, "-p tcp -m conntrack --ctstate NEW,RELATED,ESTABLISHED -m connlimit --connlimit-above 10 --connlimit-mask 0 -j REJECT --reject-with tcp-reset"),
)
