...
var _ = Describe("kube-controllers metrics tests", func() {
	...
	It("should export metrics for IPAM state", func() {
		...
		validateExpectedAndUnexpectedMetrics(
			[]string{
				`ipam_pool_size{ippool="test-ippool-1"} 256`,
		...
		validateExpectedAndUnexpectedMetrics(
			[]string{
				...
				`ipam_gc_candidates{ippool="test-ippool-1",node="node-b"} 1`,
			},
			[]string{},
			kubeControllers.IP,
		...
		validateExpectedAndUnexpectedMetrics(
			[]string{
				...
				`ipam_gc_reclamations{ippool="test-ippool-1",node="node-b"} 1`,
			},
			[]string{
				`ipam_gc_candidates{ippool="test-ippool-2",node="node-a"}`,
				`ipam_gc_candidates{ippool="test-ippool-1",node="node-b"}`,
			},
			kubeControllers.IP,
			time.Minute, 2*time.Second,
		)
		...
		validateExpectedAndUnexpectedMetrics(
			...
			[]string{
				`ipam_gc_reclamations{ippool="test-ippool-1",node="node-b"}`,
