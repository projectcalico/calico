...
func (pg *phaseGate) wrapClient(c rtclient.WithWatch) rtclient.WithWatch {
	return interceptor.NewClient(c, interceptor.Funcs{
		SubResourceUpdate: func(ctx context.Context, client rtclient.Client, subResourceName string, obj rtclient.Object, opts ...rtclient.SubResourceUpdateOption) error {
