...
func (f *fakeIPAMClient) ClaimAffinity(ctx context.Context, cidr cnet.IPNet, affinityCfg model.AffinityConfig) ([]cnet.IPNet, []cnet.IPNet, error) {
	panic("not implemented") // TODO: Implement
}
...
func (f *fakeIPAMClient) ReleaseHostAffinities(ctx context.Context, affinityCfg model.AffinityConfig, mustBeEmpty bool) error {
	f.Lock()
	defer f.Unlock()
...
func (f *fakeIPAMClient) RemoveIPAMHost(ctx context.Context, affinityCfg model.AffinityConfig) error {
	panic("not implemented") // TODO: Implement
}
