...
func NewServiceAccountController(ctx context.Context, k8sClientset kubernetes.Interface, c client.Interface, reconcilerPeriod time.Duration) controller.Controller {
