...
func mergeMigrationController(status *v3.KubeControllersConfigurationStatus, rCfg *RunConfig, apiCfg v3.KubeControllersConfigurationSpec) {
	...
	if apiCfg.Controllers.Migration != nil {
		if apiCfg.Controllers.Migration.PolicyNameMigrator == "Disabled" {
			rCfg.Controllers.Migration.PolicyNameMigrator = "Disabled"
			status.RunningConfig.Controllers.Migration.PolicyNameMigrator = "Disabled"
		}
	}
}
