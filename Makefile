...
GENERATED_FILES:=proto/felixbackend.pb.go bpf/bpf-packr.go bpf/packrd/packed-packr.go bpf/xdp/generated/xdp.o bpf/sockmap/generated/sockops.o bpf/sockmap/generated/redir.o bpf/asm/opcode_string.go
...
bpf-ut: bin/bpf.test image
	$(DOCKER_RUN) \
		...
		../../bin/bpf.test -test.v -test.run "$(FOCUS)"'
