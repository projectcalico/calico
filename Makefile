...
CHART_RELEASE := $(shell cat $(VERSIONS_FILE) | $(YAML_CMD) read - '[0].chart.revision')
CHART_VER := $(shell cat $(VERSIONS_FILE) | $(YAML_CMD) read - '[0].chart.version')
