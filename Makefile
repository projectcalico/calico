...
bin/gh:
	@mkdir -p bin
	@curl -sSL --retry 5 $(CURL_GITHUB_OPTS) -o bin/gh.tgz https://github.com/cli/cli/releases/download/v$(GITHUB_CLI_VERSION)/gh_$(GITHUB_CLI_VERSION)_linux_amd64.tar.gz
