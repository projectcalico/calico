...
ADMINPOLICY_SUPPORTED_FEATURES ?= "AdminNetworkPolicy,SupportAdminNetworkPolicyEgressInlineCIDRPeers"
...
e2e-test:
	...
	KUBECONFIG=$(KIND_KUBECONFIG) ./e2e/bin/adminpolicy/e2e.test -debug -exempt-features=$(ADMINPOLICY_UNSUPPORTED_FEATURES) -supported-features=$(ADMINPOLICY_SUPPORTED_FEATURES)
