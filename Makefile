...
release-publish: release-prereqs
	...
	docker push gcr.io/projectcalico-org/typha$(ARCHTAG):$(VERSION)
	docker push eu.gcr.io/projectcalico-org/typha$(ARCHTAG):$(VERSION)
	docker push asia.gcr.io/projectcalico-org/typha$(ARCHTAG):$(VERSION)
	docker push us.gcr.io/projectcalico-org/typha$(ARCHTAG):$(VERSION)
