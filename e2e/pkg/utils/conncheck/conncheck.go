...
type ConnectionTester interface {
	...
	ExpectSuccessContinuously(client *Client, targets ...Target) Checkpointer
}
...
func (c *connectionTester) ExpectSuccessContinuously(client *Client, targets ...Target) Checkpointer {
