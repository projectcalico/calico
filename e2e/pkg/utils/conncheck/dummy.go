...
func (d *DummyConnectionTester) ExpectEncrypted(_ Client, _ Target) {
	Fail("Unexpected ExpectEncrypted call")
}

func (d *DummyConnectionTester) ExpectPlaintext(_ Client, _ Target) {
	Fail("Unexpected ExpectPlaintext call")
}
