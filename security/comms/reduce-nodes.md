...
total, consider {% include open-new-window.html text='scheduling Typha to well-known nodes' url='https://kubernetes.io/docs/concepts/configuration/assign-pod-node/' %}.
