...
| Feature             |                                                              |
| ------------------- | ------------------------------------------------------------ |
| Distributions       | **Supported:** EKS ([non-production only](#service-clusterips-incompatible-with-selectors-on-pod-ips-in-network-policy)), AKS, AWS. GCE, Azure, Kubernetes on-premises, Kubernetes on DigitalOcean, OpenShift. <br />**Not supported**: GKE, IKS, OpenStack, K3 clusters |
