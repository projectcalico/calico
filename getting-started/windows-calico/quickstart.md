...
1. {% include open-new-window.html text='Install kubectl' url='https://docs.aws.amazon.com/eks/latest/userguide/install-kubectl.html#windows' %} and move the kubectl binary to **c:\k**.
