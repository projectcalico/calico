...
Ports to Internet guide]({{site.url}}/using-calico/advanced/ExposePortsToInternet).)
...
to [expose a container port to the internet]({{site.url}}/using-calico/advanced/ExposePortsToInternet)
when using Calico.
