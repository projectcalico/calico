...
In OpenShift Container Platform, the {% include open-new-window.html text='Operator Lifecycle Manager' url='https://docs.openshift.com/container-platform/4.4/operators/understanding_olm/olm-understanding-olm.html#olm-overview_olm-understanding-olm' %} helps
