...
func PreregisterMetrics(serverID string) {
	promutils.PreCreateGaugePerSyncer(serverID, gaugeVecCurrentSequenceNumber)
	promutils.PreCreateGaugePerSyncer(serverID, gaugeVecCurrentBreadcrumbTimestamp)
	promutils.PreCreateGaugePerSyncer(serverID, gaugeVecSnapshotSize)
	promutils.PreCreateCounterPerSyncer(serverID, counterVecBreadcrumbNonBlock)
	promutils.PreCreateCounterPerSyncer(serverID, counterVecBreadcrumbBlock)
	promutils.PreCreateCounterPerSyncer(serverID, counterVecUpdatesTotal)
	promutils.PreCreateCounterPerSyncer(serverID, counterVecUpdatesSkipped)
}
