...
func (s *SyncerClient) refreshConnID() {
	...
	s.logCxt = s.logCxt.WithField("myID", s.connID)
}
...
func (s *SyncerClient) logConnectionFailure(cxt context.Context, logCxt log.Logger, err error, operation string) {
	if cxt.Err() != nil {
...
func (s *SyncerClient) restartDecoder(cxt context.Context, logCxt log.Logger, msg syncproto.MsgDecoderRestart) error {
...
func (s *SyncerClient) sendMessageToServer(cxt context.Context, logCxt log.Logger, op string, message any) error {
...
func (s *SyncerClient) readMessageFromServer(cxt context.Context, logCxt log.Logger) (any, error) {
