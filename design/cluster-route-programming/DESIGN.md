...
[`design/MAINTAINING.md`](../MAINTAINING.md) governs edits to this file: the
default is no edit, and an edit that does belong is normally one to three lines
in a section that is already there.  A PR that changes which component programs
