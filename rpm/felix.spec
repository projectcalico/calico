...
%changelog
* Fri Jan 19 2018 Neil Jerram <neil@tigera.io> 2.6.5-1
  - Felix 2.6.5 (from Git commit 42fcfea).
    [Changes recorded in 2.6.5 tag]
...
* Wed Dec 20 2017 Neil Jerram <neil@tigera.io> 2.6.3-1
  - Felix 2.6.3 (from Git commit 7f8f06c).
    ...
    * Handle config changes for ClusterGUID, ClusterType, CalicoVersion: https://github.com/projectcalico/felix/pull/1631
    ...
    [Changes recorded in 2.6.3-rc2 tag]
    - Backport fix for felix failure to restart. (#1646)
    - Backport liveness check changes (#1653)
    [Changes recorded in 2.6.3-rc1 tag]
    - Handle config changes for ClusterGUID, ClusterType, CalicoVersion. - https://github.com/projectcalico/felix/pull/1641
    - Backport fix for felix failure to restart. - https://github.com/projectcalico/felix/pull/1646
    [Changes recorded in 2.6.2 tag]
    - Rev libcalico-go to pick up resync fix
    - Fix config batcher: unset dirty flag after flush.
    [Changes recorded in 2.6.1 tag]
