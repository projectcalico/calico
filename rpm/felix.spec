...
%changelog
* Wed May 30 2018 Neil Jerram <neil@tigera.io> 3.1.3-1
  - Felix 3.1.3 (from Git commit 4d7bb9a).
    [Changes recorded in 3.1.3 tag]
    - dep + rpm packages for Calico v3.1.2
    - Fix staticchecks lint.
