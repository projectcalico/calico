...
| ignoredInterfaces      | List of network interfaces to be excluded when reading device routes.                                                                                                                                                                                                                                                                                                                                                          | A list of network interface names.                      | List of string                               | `nil` (no extra interfaces to be ignored) |
