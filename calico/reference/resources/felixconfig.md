...
| bpfL3IfacePattern                | This is same as bpfDataIfacePattern but in addition it means the interface is a tunnel device like wireguard. | regular expression | string | `^(wireguard.cali$|wg-v6.cali$)` |
