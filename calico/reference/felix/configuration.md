...
| BPFEnforceRPF                      / <br/> FELIX_BPFENFORCERPF                        | Enforce RPF on all interfaces with BPF programs regardless of what is the per-interfaces or global setting. | Disabled,Strict,Loose | Strict |
