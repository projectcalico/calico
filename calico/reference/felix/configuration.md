...
| `mtuIfacePattern`                 | `FELIX_MTUIFACEPATTERN`                 | Pattern used to discover the host's interface for MTU auto-detection. [Default: <code>^((en&#124;wl&#124;ww&#124;sl&#124;ib)[Pcopsvx].* &#124;(eth&#124;wlan&#124;wwan).*)</code> ] | regex |
