...
| BPFPolicyDebugEnabled  / <br/> FELIX_BPFPOLICYDEBUGENABLED    | In eBPF dataplane mode, controls whether felix will collect policy dump for each interface. | true, false |  true |
