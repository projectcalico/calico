...
| BPFL3IfacePattern                / <br/> FELIX_BPFL3IFACEPATTERN                  | Same as BPFDataIfacePattern but in addition it means the device is a L3 tunnel device like wireguard, vxlan. | regular expression | `^(wireguard.cali$|wg-v6.cali$)` |
