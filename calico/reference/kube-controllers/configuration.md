...
1. policy controller: watches Kubernetes network policies in the Kubernetes API and syncs the policies to the datastore (etcd) as {{site.prodname}} network policies.
