...
class NetworkStore(object):
    ...
    def add_processor(self, rule_processor):
        ...
        The Network Store only supports a single Rule Processor, and one must
        be provided before update_group is called.
        """
        assert self.rule_processor is None
    ...
    def update_group(self, group_uuid, members, rules):
        ...
        assert self.rule_processor is not None
        self.rule_processor.recalc_rules()
