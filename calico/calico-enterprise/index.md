...
1. Verify that your [cluster is compatible](ttps://docs.calicocloud.io/operations/connect/system-requirements). Want to know what happens when you connect/disconnect your cluster to Calico Cloud? See {% include open-new-window.html text='Connect your cluster to Calico Cloud' url='https://docs.calicocloud.io/operations/connect/connect-cluster' %}.
