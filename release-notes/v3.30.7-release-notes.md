...
- Support for non-privileged mode is no longer available for Operator installations. The `Installation.spec.nonPrivileged` field is deprecated and ignored; setting it to `Enabled` will mark Calico as `Degraded`. [calico 12091](https://github.com/projectcalico/calico/pull/12091) (@MichalFupso)
