...
- Updates LoadBalancer controller to not run when not explicitly configured as part of ENABLED_CONTROLLERS [calico 12055](https://github.com/projectcalico/calico/pull/12055) (@MichalFupso)
- LoadBalancer controller prevent nil pointer dereference in handleBlockUpdate [calico 11923](https://github.com/projectcalico/calico/pull/11923) (@MichalFupso)
