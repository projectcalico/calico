...
Param(
    [parameter(Mandatory = $false)] $ReleaseBaseURL="https://github.com/projectcalico/calico/releases/download/v3.21.2/",
    [parameter(Mandatory = $false)] $ReleaseFile="calico-windows-v3.21.2.zip",
