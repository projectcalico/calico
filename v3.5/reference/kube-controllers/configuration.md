...
## The {{site.data.versions[page.version].first.registry}}{{site.imageNames["kubeControllers"]}} container

The `{{site.data.versions[page.version].first.registry}}{{site.imageNames["kubeControllers"]}}` container includes the following controllers:
