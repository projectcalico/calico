...
class TestNamespace(TestBase):
    ...
    def setUpClass(cls):
        ...
        handle_failure(lambda: retry_until_success(cls.host1.assert_is_ready, retries=10))
        handle_failure(lambda: retry_until_success(cls.host2.assert_is_ready, retries=10))
