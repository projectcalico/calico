...
1. Add the projectcalico helm repository.
   ...
   ```
   helm repo add projectcalico https://docs.tigera.io/calico/latest/charts
   ```
...
# here: hhttps://docs.tigera.io/calico/latest/reference/installation/api#operator.tigera.io/v1.InstallationSpec
installation:
  enabled: true
  kubernetesProvider: ""
