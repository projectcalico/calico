...
of what Neutron generally allows (see [External Connectivity]({{site.baseurl}}/{{page.version}}/getting-started/openstack)) and because it's a purely layer 3 model (see [The Calico Datapath]({{site.baseurl}}/{{page.version}}/reference/architecture/data-path), not all Neutron API calls will have the same effect as they would with other backends.
...
found in [this document]({{site.baseurl}}/{{page.version}}/getting-started/openstack#opens-external-conn-setup).
...
[this document]({{site.baseurl}}/{{page.version}}/getting-started/openstack) to understand why Neutron provider networks are not
needed.
...
be found [here]({{site.baseurl}}/{{page.version}}/getting-started/openstack#opens-external-conn-setup).
...
simply aren't required. For more information, see [this document]({{site.baseurl}}/{{page.version}}/getting-started/openstack).
...
[this document]({{site.baseurl}}/{{page.version}}/getting-started/openstack) for details on how to achieve this setup.
