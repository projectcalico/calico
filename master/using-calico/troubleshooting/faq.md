...
[here]({{site.url}}/{{page.version}}/reference/private-cloud/l2-interconnect-fabric)) or a layer 3 (see [here]({{site.url}}/{{page.version}}/reference/private-cloud/l3-interconnect-fabric)) fabric
...
Calico provides an extremely rich security policy model, detailed [here]({{site.url}}/{{page.version}}/reference/security-model). This model applies the policy at the first and last hop
