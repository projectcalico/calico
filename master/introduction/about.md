...
<div id="why-use-calico-2" class="row">
  <div class="col-md-6">
    <h3 id="best-practices-for-network-policy" style="margin-top: 5px">Best practices for network security</h3>
...
<div id="why-use-calico-8" class="row">
  <div class="col-md-6">
    <h3 id="full-kubernetess-support" style="margin-top: 5px">Full Kubernetes network policy support</h3>
