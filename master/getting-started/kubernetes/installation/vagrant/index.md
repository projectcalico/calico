...
```shell
wget http://storage.googleapis.com/kubernetes-release/release/v1.5.0/bin/darwin/amd64/kubectl
chmod +x ./kubectl
```
...
```shell
wget http://storage.googleapis.com/kubernetes-release/release/v1.5.0/bin/linux/amd64/kubectl
chmod +x ./kubectl
```
