...
```
      - name: dikastes
        image: {{site.data.versions[page.version].first.registry}}{{site.imageNames["dikastes"]}}:{{site.data.versions[page.version].first.components["calico/dikastes"].version}}
