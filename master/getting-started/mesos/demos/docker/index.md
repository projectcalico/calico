...
check out [Calico's Docker Containerizer guide]({{site.url}}/{{page.version}}/getting-started/mesos/installation/docker).
...
deploy a master and two agents. Follow the [Vagrant Mesos Guide]({{site.url}}/{{page.version}}/getting-started/mesos/vagrant)
to get started.
