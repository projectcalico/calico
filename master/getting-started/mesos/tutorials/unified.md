...
CNI enabled, and Calico services and binaries are installed. See [Adding Calico-CNI to an existing Mesos Cluster]({{site.url}}/{{page.version}}/getting-started/mesos/installation/unified), or use the [Docker-Compose Demo Cluster](cni-compose-demo/) to meet these requirements.
