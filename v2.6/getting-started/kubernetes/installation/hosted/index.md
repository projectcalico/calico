...
```
kubectl apply -f https://github.com/projectcalico/calico/tree/master/v2.6/getting-started/kubernetes/installation/hosted/kubernetes-datastore/calico-networking/1.7/calico.yaml
```
