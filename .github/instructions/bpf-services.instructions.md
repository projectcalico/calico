...
applyTo:
  - "felix/bpf/proxy/**"
  - "felix/bpf/nat/**"
  - "felix/bpf/consistenthash/**"
  - "felix/bpf-gpl/connect*.c"
  - "felix/bpf-gpl/connect*.h"
  - "felix/bpf-gpl/nat*.h"
  - "felix/bpf-gpl/nat_lookup.h"
  - "felix/bpf-gpl/maglev.h"
  - "felix/bpf-gpl/ctlb*.h"
  - "felix/bpf-gpl/sendrecv.h"
  - "felix/dataplane/linux/bpf_ep_mgr.go"
---

# eBPF dataplane: bpf-services

The design and review criteria for this area of the Calico
eBPF dataplane live in
[`felix/design/bpf-services.md`](../../felix/design/bpf-services.md). The
...
`bpf-services.md` and apply those review notes.
