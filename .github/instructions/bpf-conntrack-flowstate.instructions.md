...
applyTo:
  - "felix/bpf/conntrack/**"
  - "felix/bpf-gpl/conntrack*.c"
  - "felix/bpf-gpl/conntrack*.h"
  - "felix/bpf-gpl/rpf.h"
  - "felix/bpf/allowsources/**"
  - "felix/rules/static.go"
---

# eBPF dataplane: bpf-conntrack-flowstate

The design and review criteria for this area of the Calico
eBPF dataplane live in
[`felix/design/bpf-conntrack-flowstate.md`](../../felix/design/bpf-conntrack-flowstate.md). The
...
`bpf-conntrack-flowstate.md` and apply those review notes.
