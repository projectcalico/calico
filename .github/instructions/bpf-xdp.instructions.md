...
applyTo:
  - "felix/bpf-gpl/xdp.c"
  - "felix/bpf-gpl/xdp_preamble.c"
  - "felix/bpf-gpl/metadata.h"
  - "felix/bpf/xdp/**"
---

# eBPF dataplane: bpf-xdp

The design and review criteria for this area of the Calico
eBPF dataplane live in
[`felix/design/bpf-xdp.md`](../../felix/design/bpf-xdp.md). The
...
`bpf-xdp.md` and apply those review notes.
