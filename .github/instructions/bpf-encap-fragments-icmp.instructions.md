...
applyTo:
  ...
  - "felix/bpf-gpl/tc_ip_frag.c"
  - "felix/bpf-gpl/icmp*.h"
  - "felix/bpf-gpl/fib*.h"
  - "felix/bpf/routes/**"
  - "felix/dataplane/linux/vxlan_mgr.go"
---

# eBPF dataplane: bpf-encap-fragments-icmp

The design and review criteria for this area of the Calico
eBPF dataplane live in
[`felix/design/bpf-encap-fragments-icmp.md`](../../felix/design/bpf-encap-fragments-icmp.md). The
...
`bpf-encap-fragments-icmp.md` and apply those review notes.
