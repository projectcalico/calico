...
applyTo:
  ...
  - "felix/bpf/qos/**"
  - "felix/bpf-gpl/log.h"
  - "felix/bpf-gpl/events*.h"
  - "felix/bpf-gpl/qos.h"
  - "felix/bpf-gpl/ringbuf.h"
---

# eBPF dataplane: bpf-observability

The design and review criteria for this area of the Calico
eBPF dataplane live in
[`felix/design/bpf-observability.md`](../../felix/design/bpf-observability.md). The
...
`bpf-observability.md` and apply those review notes.
