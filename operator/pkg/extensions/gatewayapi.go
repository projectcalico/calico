...
type GatewayAPIExtension interface {
	...
	// GatewayNamespaceObjects returns what a namespace hosting a Gateway needs
	// beyond the trusted bundle the core operator writes there.
	GatewayNamespaceObjects(namespace string, pullSecrets []*corev1.Secret) []client.Object
}
...
func (noopGatewayAPI) Modify(c render.Component, _ render.Inputs) render.Component {
	return c
}

func (noopGatewayAPI) GatewayNamespaceObjects(string, []*corev1.Secret) []client.Object {
	return nil
}
