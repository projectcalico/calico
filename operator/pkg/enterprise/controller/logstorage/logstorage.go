...
import (
	...
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/dashboards"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/elastic"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/esmetrics"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/initializer"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/kubecontrollers"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/linseed"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/managedcluster"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/secrets"
	"github.com/projectcalico/calico/operator/pkg/enterprise/controller/logstorage/users"
)

// Add adds all of the log storage sub-controllers to the controller manager. Each
// reconciles independently and they coordinate through the Kubernetes API rather than
// with each other.
func Add(mgr ctrl.Manager, opts options.ControllerOptions) error {
