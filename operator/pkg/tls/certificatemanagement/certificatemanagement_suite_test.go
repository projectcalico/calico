...
func TestCertificateManagement(t *testing.T) {
	...
	reporterConfig.JUnitReport = "../../../report/ut/tls_certificatemanagement_suite.xml"
	ginkgo.RunSpecs(t, "pkg/tls/certificatemanagement Suite", suiteConfig, reporterConfig)
}
