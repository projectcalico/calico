...
import (
	...
	"github.com/projectcalico/calico/operator/pkg/controller/packetcapture"
)
...
func (pc *PacketCaptureReconciler) SetupWithManager(mgr ctrl.Manager, opts options.ControllerOptions) error {
