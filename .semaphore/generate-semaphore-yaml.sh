...
sed -i "s/\${FELIX_CHANGE_IN}/$(go run ./hack/deps sem-change-in felix)/g" semaphore.yml
sed -i "s/\${FELIX_CHANGE_IN}/$(go run ./hack/deps sem-change-in felix)/g" semaphore-scheduled-builds.yml
