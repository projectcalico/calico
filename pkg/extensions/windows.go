...
func (noopWindows) ExtendInputs(_ context.Context, ci controller.Inputs) (controller.Inputs, []certificatemanagement.KeyPairInterface, error) {
	return ci, nil, nil
}
...
func (noopWindows) Modify(c render.Component, _ render.Inputs) render.Component {
	return c
}
