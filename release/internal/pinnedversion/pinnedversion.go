...
func (p *CalicoPinnedVersions) GenerateFile() (version.Data, error) {
	...
	versionData := version.NewCalicoVersionData(version.New(productVer), operatorVer)
...
func RetrieveVersions(outputDir string) (version.Data, error) {
	...
	return version.NewCalicoVersionData(version.New(pinnedVersion.Title), pinnedVersion.TigeraOperator.Version), nil
}
