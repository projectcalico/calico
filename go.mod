...
require (
	...
	k8s.io/csi-translation-lib v0.33.7 // indirect
	k8s.io/dynamic-resource-allocation v0.33.7 // indirect
	k8s.io/kms v0.33.7 // indirect
	k8s.io/kube-scheduler v0.33.7 // indirect
	k8s.io/kubectl v0.33.7 // indirect
	k8s.io/kubelet v0.33.7 // indirect
	k8s.io/mount-utils v0.33.7 // indirect
	k8s.io/pod-security-admission v0.33.7
