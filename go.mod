...
require (
	...
	github.com/projectcalico/cni-plugin v1.11.1-0.20210730164435-becfea1e40ee
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210730162439-08277b9061bd
