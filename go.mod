...
require (
	...
	github.com/projectcalico/cni-plugin v1.11.1-0.20210727121946-aa0e30ff78f6
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210727112303-1615f4eba0e0
