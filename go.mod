...
require (
	...
	k8s.io/kube-scheduler v0.30.11 // indirect
	k8s.io/kubectl v0.30.11 // indirect
	k8s.io/kubelet v0.30.11 // indirect
	k8s.io/legacy-cloud-providers v0.30.11 // indirect
	k8s.io/mount-utils v0.30.11 // indirect
	k8s.io/pod-security-admission v0.30.11 // indirect
