...
require (
	...
	k8s.io/cloud-provider v0.33.11 // indirect
	k8s.io/component-helpers v0.33.11 // indirect
	k8s.io/controller-manager v0.33.11 // indirect
	k8s.io/cri-api v0.33.11 // indirect
	k8s.io/cri-client v0.33.11 // indirect
	...
	k8s.io/kubectl v0.33.11 // indirect
	k8s.io/kubelet v0.33.11 // indirect
	k8s.io/mount-utils v0.33.11 // indirect
	k8s.io/pod-security-admission v0.33.11
