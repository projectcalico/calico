...
require (
	...
	k8s.io/pod-security-admission v0.35.9
...
require (
	...
	k8s.io/cloud-provider v0.35.9 // indirect
	k8s.io/component-helpers v0.35.9 // indirect
	k8s.io/controller-manager v0.35.9 // indirect
	k8s.io/cri-api v0.35.9 // indirect
	k8s.io/cri-client v0.35.9 // indirect
	k8s.io/csi-translation-lib v0.35.9 // indirect
	k8s.io/dynamic-resource-allocation v0.35.9 // indirect
	k8s.io/kms v0.35.9 // indirect
	k8s.io/kube-scheduler v0.35.9 // indirect
	k8s.io/kubelet v0.35.9 // indirect
	k8s.io/mount-utils v0.35.9 // indirect
