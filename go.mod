...
require (
	...
	github.com/projectcalico/typha v0.7.3-0.20210406203422-bbbc1ca12ed4
...
replace (
	...
	github.com/projectcalico/libcalico-go => github.com/sridhartigera/libcalico-go v1.7.2-0.20210407223916-8d7afd20369b
