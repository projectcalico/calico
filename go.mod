...
require (
	...
	github.com/projectcalico/felix v0.0.0-20211028032655-a7ad56811a54
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20211028004347-5143d79b9e6e
