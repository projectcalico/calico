...
require (
	...
	github.com/projectcalico/felix v0.0.0-20201209215905-361db29f20f2
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20201209191947-9dbc6f8579fd
