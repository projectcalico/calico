...
require (
	...
	github.com/projectcalico/felix v0.0.0-20190910200733-dbc6c9a3b31b
...
replace github.com/kelseyhightower/confd => github.com/projectcalico/confd v0.0.0-20190910042248-adc7460da37f
