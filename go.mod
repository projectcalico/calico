...
require (
	...
	github.com/projectcalico/typha v0.7.3-0.20210719203818-dcc7ff67d9d9
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210719204710-788346b7b467
