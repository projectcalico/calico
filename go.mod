...
require (
	...
	github.com/projectcalico/felix v0.0.0-20201209100943-120c6628aef2
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20201209000913-75a28eddb3ba
