...
require (
	...
	github.com/projectcalico/felix v0.0.0-20210223100544-c7bd859cad4b
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210211113720-332a683576bd
