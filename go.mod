...
require (
	...
	github.com/projectcalico/felix v0.0.0-20201221195443-7b3bfe7a5d7b
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20201221185516-225a3205c0e1
