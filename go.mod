...
require (
	...
	github.com/projectcalico/felix v0.0.0-20201211114156-3d9fa4b24f5f
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20201211103444-6be67da221cd
