...
require (
	...
	github.com/projectcalico/felix v0.0.0-20211027143757-34ac0a842158
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20211025230507-61f89f88a6eb
