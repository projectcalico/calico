...
require (
	...
	k8s.io/cri-api v0.30.8 // indirect
	...
	k8s.io/kubectl v0.30.8 // indirect
	k8s.io/kubelet v0.30.8 // indirect
	k8s.io/legacy-cloud-providers v0.30.8 // indirect
	k8s.io/mount-utils v0.30.8 // indirect
	k8s.io/pod-security-admission v0.30.8 // indirect
...
replace (
	...
	k8s.io/endpointslice => k8s.io/endpointslice v0.30.8
