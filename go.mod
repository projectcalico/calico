...
require (
	...
	github.com/projectcalico/calico/lib/logrus v0.0.0-00010101000000-000000000000
	...
	github.com/tigera/operator/api v0.0.0-20260420175011-b93a68d9cae0
...
replace (
	...
	github.com/projectcalico/calico/lib/logrus => ./lib/logrus
