...
require (
	...
	github.com/projectcalico/felix v0.0.0-20200518153059-f20bcc4d5067
...
replace (
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20200516080959-b0a2859a98d6
