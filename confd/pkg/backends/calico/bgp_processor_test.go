...
func TestBuildImportFilter_EmptyFilters(t *testing.T) {
	...
	result := c.buildImportFilter([]string{}, "65000", "64512", 4, 1024)
	assert.Contains(t, result, "accept;")
}
...
func TestBuildImportFilter_IPv4vsIPv6(t *testing.T) {
	...
	resultV4 := c.buildImportFilter(nil, "65000", "64512", 4, 1024)
	resultV6 := c.buildImportFilter(nil, "65000", "64512", 6, 1024)
...
func TestBuildImportFilter_WithBGPFilter(t *testing.T) {
	...
	result := c.buildImportFilter([]string{"my-filter"}, "65000", "64512", 4, 1024)
...
func TestBuildImportFilter_WithMultipleBGPFilters(t *testing.T) {
	...
	result := c.buildImportFilter([]string{"filter1", "filter2"}, "65000", "64512", 4, 1024)
...
func TestBuildImportFilter_IPv6Filter(t *testing.T) {
	...
	result := c.buildImportFilter([]string{"ipv6-filter"}, "65000", "64512", 6, 1024)
...
func TestBuildImportFilter_FilterWithNoImportRules(t *testing.T) {
	...
	result := c.buildImportFilter([]string{"export-only"}, "65000", "64512", 4, 1024)
...
func TestBuildImportFilter_FilterNotFound(t *testing.T) {
	...
	result := c.buildImportFilter([]string{"nonexistent-filter"}, "65000", "64512", 4, 1024)
