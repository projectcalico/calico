...
// SetLogLevel sets the global logrus level from a string. On parse
// failure it falls back to InfoLevel and logs a warning. Valid levels
// are panic, fatal, error, warn, info, debug.
