...
func RunWithContext(
	...
	if storeClient == nil {
		var err error
		storeClient, err = calico.NewCalicoClient(cc, k8sClient, datastoreConfig, typhaConfig)
		if err != nil {
...
func createClients(cfg *config.Config) (clientv3.Interface, kubernetes.Interface, *apiconfig.CalicoAPIConfig, error) {
	...
	return cc, k8sClient, clientCfg, nil
}
