...
// GetPrivateKeyInfo returns the appropriate keyAlgorithm and key usages based on the input value for keyAlgorithm.
// For unknown or missing inputs, we default to RSAWithSize2048.
