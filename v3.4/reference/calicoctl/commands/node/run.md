...
Options:
  -h --help                Show this screen.
     ...
     --node-image=<DOCKER_IMAGE_NAME>
                           ...
                           [default: {{site.data.versions[page.version].first.registry}}{{site.imageNames["node"]}}:latest]
     --backend=(bird|none)
