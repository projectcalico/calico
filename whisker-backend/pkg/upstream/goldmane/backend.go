...
func (b *Backend) List(ctx context.Context, params whiskerv1.ListFlowsParams) (apiutil.ListMeta, []whiskerv1.FlowResponse, error) {
	...
	if err != nil {
		return apiutil.ListMeta{}, nil, err
	}
	...
	return protoToListMeta(meta), rspFlows, nil
}

func protoToListMeta(meta *proto.ListMetadata) apiutil.ListMeta {
	if meta == nil {
		return apiutil.ListMeta{}
	}
	return apiutil.ListMeta{
		TotalPages:   int(meta.TotalPages),
		TotalResults: int(meta.TotalResults),
	}
}
...
func (b *Backend) FilterHints(ctx context.Context, params whiskerv1.FlowFilterHintsRequest, includeFlow whiskerv1.FlowFilterFunc) (apiutil.ListMeta, []whiskerv1.FlowFilterHintResponse, error) {
	...
	return protoToListMeta(meta), hints, nil
}
