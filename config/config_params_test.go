...
var _ = DescribeTable("Config parsing",
	...
	Entry("FailsafeInboundHostPorts old syntax", "FailsafeInboundHostPorts", "1,2,3,4",
		[]config.ProtoPort{
			...
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 2},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 3},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 4},
		}),
	...
	Entry("FailsafeInboundHostPorts new cidr syntax", "FailsafeInboundHostPorts", "0.0.0.0/0:tcp:1,0.0.0.0/0:udp:2",
		[]config.ProtoPort{
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 1},
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 2},
		}),
	Entry("FailsafeOutboundHostPorts new cidr syntax", "FailsafeOutboundHostPorts", "0.0.0.0/0:tcp:1,0.0.0.0/0:udp:2",
		[]config.ProtoPort{
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 1},
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 2},
		}),
	...
	Entry("FailsafeInboundHostPorts new mixed syntax", "FailsafeInboundHostPorts", "1,0.0.0.0/0:udp:2",
		[]config.ProtoPort{
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 1},
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 2},
		}),
	Entry("FailsafeOutboundHostPorts new mixed syntax", "FailsafeOutboundHostPorts", "1,0.0.0.0/0:udp:2",
		[]config.ProtoPort{
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 1},
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 2},
		}),
	Entry("FailsafeInboundHostPorts bad syntax -> defaulted", "FailsafeInboundHostPorts", "foo:1",
		[]config.ProtoPort{
			...
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 68},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 179},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 2379},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 2380},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 5473},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 6443},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 6666},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 6667},
		},
		true,
	),
	...
	Entry("FailsafeOutboundHostPorts empty", "FailsafeOutboundHostPorts", "",
		[]config.ProtoPort{
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 53},
			{Net: "0.0.0.0/0", Protocol: "udp", Port: 67},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 179},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 2379},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 2380},
			{Net: "0.0.0.0/0", Protocol: "tcp", Port: 5473},
