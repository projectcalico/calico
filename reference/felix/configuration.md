...
| BPFKubeProxyEndpointSlicesEnabled  / <br/> FELIX_BPFKUBEPROXYENDPOINTSLICESENABLED    | Controls whether Felix's embedded kube-proxy can process EndpointSlices. Can be enabled only if enabled in k8s as well | true,false | true |
