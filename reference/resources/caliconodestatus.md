...
As of today, status of BGP agents, BGP sessions and routes exposed to BGP agents are collected from Linux nodes only. <mark>Windows nodes are not supported at this time.</mark>
