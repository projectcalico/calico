...
| BPFKubeProxyEndpointSlicesEnabled  | In eBPF dataplane mode, controls whether Felix's embedded kube-proxy can process EndpointSlices. Can be enabled only if enabled in k8s as well | true,false | boolean | true |
