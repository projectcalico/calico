...
resource type is documented in the [Resources]({{ site.baseurl }}/reference/resources/) guide.
...
resource type are documented in the [Resources]({{ site.baseurl }}/reference/resources/) guide.
...
resource-lists are defined in the [libcalico API]({{ site.baseurl }}/reference/resources/) and there is a resource-list defined for
