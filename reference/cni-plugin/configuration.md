...
{% include open-new-window.html text='configuration mechanism' url='https://github.com/containernetworking/cni/blob/master/SPEC.md#network-configuration' %}
...
A specific IP address can be chosen by using {% include open-new-window.html text='`CNI_ARGS`' url='https://github.com/appc/cni/blob/master/SPEC.md#parameters' %} and setting `IP` to the desired value.
...
In addition to specifying IP pools in the CNI config as discussed above, {{site.prodname}} IPAM supports specifying IP pools per-namespace or per-pod using the following {% include open-new-window.html text='Kubernetes annotations' url='https://kubernetes.io/docs/user-guide/annotations/' %}.
...
You can also request a specific IP address through {% include open-new-window.html text='Kubernetes annotations' url='https://kubernetes.io/docs/user-guide/annotations/' %} with {{site.prodname}} IPAM.
...
You can request a floating IP address for a pod through {% include open-new-window.html text='Kubernetes annotations' url='https://kubernetes.io/docs/user-guide/annotations/' %} with {{site.prodname}}.
...
The CNI 0.3.0 {% include open-new-window.html text='spec' url='https://github.com/containernetworking/cni/blob/spec-v0.3.0/SPEC.md#network-configuration-lists' %} supports "chaining" multiple CNI plugins together. {{site.prodname}} supports the following Kubernetes CNI plugins, which are enabled by default. Although chaining other CNI plugins may work, we support only the following tested CNI plugins. 
