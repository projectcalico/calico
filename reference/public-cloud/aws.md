...
- **No 50 Node Limit**: {{site.prodname}} allows you to surpass the 50 node limit, which exists as a consequence of the {% include open-new-window.html text='AWS 50 route limit' url='http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Appendix_Limits.html#vpc-limits-route-tables' %} when using the VPC routing table.
...
{% include open-new-window.html text='as described in the AWS documentation' url='http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_NAT_Instance.html#EIP_Disable_SrcDestCheck' %}.  This
...
use {{site.prodname}} across multiple different VPC subnets or {% include open-new-window.html text='peered VPCs' url='http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpc-peering.html' %},
