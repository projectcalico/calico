...
[BGP Configuration tutorial]({{site.url}}/using-calico/configuration/bgp) for how to do this.
...
(see the [BGP Configuration tutorial]({{site.url}}/using-calico/configuration/bgp) for more detail).
...
[Project Calico documentation]({{site.url}}/what-is-calico/connectivity/l3-interconnectFabric).
