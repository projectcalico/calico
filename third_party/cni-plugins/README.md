...
mounts at `/opt/cni/bin` and copies onto the host. See
[CORE-12829](https://tigera.atlassian.net/browse/CORE-12829) for background on
why this is a separate image rather than baked into `calico/calico`.
