...
# NC_PLUGIN_REPO
#
#     Repository for the networking-calico devstack plugin.  By default this
#     is https://github.com/projectcalico/calico.
#
# NC_PLUGIN_REF
#
#     Git ref for the networking-calico devstack plugin.  By default this is
#     master.
#
# ------------------------------------------------------------------------------
...
enable_plugin networking-calico $NC_PLUGIN_REPO $NC_PLUGIN_REF
