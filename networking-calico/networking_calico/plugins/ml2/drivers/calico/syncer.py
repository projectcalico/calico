...
# example see the get-then-CAS-put loop in ``sync_subnet``.  Sized to tolerate
# moderate per-key contention while bounding the worst case.  Drift beyond this is left
# for the next startup resync to repair.
MAX_CAS_ATTEMPTS = 5
