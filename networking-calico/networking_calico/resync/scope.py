...
from networking_calico.plugins.ml2.drivers.calico.endpoints import WorkloadEndpointSyncer
    ...
    def run(self) -> ResyncResult:
        ...
        try:
            ...
            if self.driver is not None:
                ...
                endpoint_syncer = WorkloadEndpointSyncer(self.db, _txn_from_context, policy_syncer)
