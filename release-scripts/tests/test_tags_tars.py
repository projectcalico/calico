...
TAG_URL_TEMPL = "https://github.com/projectcalico/{component}/releases/tag/{component_version}"
ZIP_URL_TEMPL = "https://github.com/projectcalico/{component}/archive/{component_version}.zip"
TAR_URL_TEMPL = "https://github.com/projectcalico/{component}/archive/{component_version}.tar.gz"
...
FLANNEL_TAG_URL_TEMPL = "https://github.com/coreos/{component}/releases/tag/{component_version}"
FLANNEL_ZIP_URL_TEMPL = "https://github.com/coreos/{component}/archive/{component_version}.zip"
FLANNEL_TAR_URL_TEMPL = "https://github.com/coreos/{component}/archive/{component_version}.tar.gz"

DOCS_TAR_URL_TEMPL = "https://github.com/projectcalico/{component}/releases/download/" \
...
components = [
    ...
    {"name": "kube-controllers",
     "lookup": "calico/kube-controllers",
     "urls": []},
    {"name": "networking-calico",
     "lookup": "networking-calico",
     "urls": []},
    {"name": "flannel",
     "lookup": "flannel",
     "urls": []},
    {"name": "app-policy",
     "lookup": "calico/dikastes",
     "urls": []},
    {"name": "pod2daemon",
     "lookup": "flexvol",
     "urls": []},
...
for component in components:
    ...
    if component['name'] == "cni-plugin":
        ...
        for binary in ['calicoctl',
            ...
            component['urls'].append(CTL_URL_TEMPL.format(
                component=component['name'],
                component_version=versions[0]['components'][component['lookup']]['version'],
                binary=binary,
            ))
        ...
        component["urls"] = [
            "https://github.com/projectcalico/networking-calico/releases/tag/{component_version}".format(
    ...
    #
    # networking-calico:
    #     https://github.com/projectcalico/networking-calico/releases/tag/3.6.0
    #
    # cni:
